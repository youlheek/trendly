...
import com.rebootcrew.trendly.common.dto.ChatReplyDto;
import com.rebootcrew.trendly.common.dto.ChatRoomDto;
...
public class ChatWebSocketApplication {
	 ...
	 * @param message
	 */
	public void handleSendMessage(Long roomId, Long userId, String nickname, String message) {
		// message DB 저장
		ChatMessageDto chatMessageDto = chatService.saveMessage(roomId, userId, nickname, message);
